      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-hidden">
        ...
        <Tabs defaultValue="appearance" className="mt-4">
          <ScrollArea className="w-full">
            <TabsList className="w-full mb-4 flex-nowrap overflow-x-auto pb-1">
              ...
              <TabsTrigger value="blocked" className="flex-shrink-0">
          ...
          <ScrollArea className="h-[60vh]">
            ...
            <TabsContent value="blocked" className="mt-0 p-1">
              <UserBlocked />
            </TabsContent>
            
            <TabsContent value="about" className="space-y-4 mt-0 p-1">
              <div>
