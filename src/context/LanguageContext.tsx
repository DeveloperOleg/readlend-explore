...
const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'publish.titlePlaceholder': 'Введите названи�� книги',
    ...
    'profile.perBookCommentsSettings': 'Настройки комментариев для отдельных ��ниг',
    ...
    'profile.commentsUpdated': 'Настройки комментарие�� обновлены',
    ...
    'profile.imageTooLarge': 'Ра��мер аватара не должен превышать 10МБ',
    ...
    'profile.unsupportedCoverFormat': 'Неподдерживаемый формат. Поддерживаемы��: JPG, PNG, WEBP',
