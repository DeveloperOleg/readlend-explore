      ...
      <ScrollArea className="h-[calc(100vh-130px)]">
        <div className="pb-4">
          <nav className="grid gap-2 mb-4">
            <TabsList className="w-full mb-4 overflow-x-auto pb-1 justify-start h-auto flex-wrap gap-2">
            ...
            {user ? (
              <div className="space-y-2 mt-4">
                <h2 className="text-lg font-medium">{t('profile.privacy') || 'Конфиденциальность'}</h2>
            ...
            <div className="mt-4">
              <h2 className="text-lg font-medium mb-2">{t('blocked.title') || 'Черный список'}</h2>
              <UserBlocked />
            </div>

            <div className="mt-4">
              <h2 className="text-lg font-medium mb-2">{t('settings.about') || 'О приложении'}</h2>
              <div className="rounded-lg border p-3">
