export const enTranslations = {
  ...
  'auth.welcome': 'Welcome to ReadNest - a platform for writers and readers',
  'auth.terms': 'By using this app, you agree to our terms of service and privacy policy.',
  'auth.usernamePlaceholder': 'Enter username',
  'auth.passwordPlaceholder': 'Enter password',
  'auth.confirmPasswordPlaceholder': 'Enter password again',
  'auth.error': 'Error',
  'auth.invalidCredentials': 'Invalid username or password',
  'auth.registrationFailed': 'Failed to register account. This username may already be taken.',
  ...
  'auth.usernameMaxLength': 'Username must be no more than 20 characters',
  'auth.usernameFormat': 'Username must start with a letter and contain only Latin letters, numbers, and underscores',
  ...
  'auth.userExists': 'User already exists. Please try logging in.',
  ...
  'security.twoFactor.status': 'Two-Factor Authentication',
  'security.twoFactor.enabled': 'Enabled',
  'security.twoFactor.disabled': 'Disabled',
  'security.twoFactor.scanQR': 'Scan this QR code with your authenticator app',
  'security.twoFactor.enterCode': 'Enter the 6-digit code from your app',
  'security.twoFactor.verify': 'Verify',
  'security.twoFactor.qrCodeGenerated': 'QR code generated. Please scan it with your authenticator app.',
  'security.twoFactor.invalidCode': 'Please enter a valid 6-digit code',
  'security.twoFactor.enableError': 'Failed to enable two-factor authentication',
  'security.twoFactor.verificationError': 'Failed to verify code. Please try again.',
  'security.twoFactor.disableError': 'Failed to disable two-factor authentication',
  ...
  'home.todayReading': 'today • cozy evening • magical reading',
  'home.weekdays.0': 'Sun',
  'home.weekdays.1': 'Mon', 
  'home.weekdays.2': 'Tue',
  'home.weekdays.3': 'Wed',
