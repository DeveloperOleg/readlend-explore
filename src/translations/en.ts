...
export const translations = {
  comic: {
    ...
    linkCopiedDescription: 'Comic link has been copied to clipboard',
    copyFailed: 'Copy failed',
    copyFailedDescription: 'Failed to copy link to clipboard',
    reportSubmitted: 'Report submitted',
    reportSubmittedDescription: 'Thank you for reporting this issue. We will review it shortly.',
    startReading: 'Started reading',
    startReadingDescription: 'You can now read this comic',
    removedFromSaved: 'Removed from saved',
    addedToSaved: 'Added to saved',
    removedFromSavedDescription: 'Comic removed from your saved list',
    addedToSavedDescription: 'Comic added to your saved list',
    removedFromFavorites: 'Removed from favorites',
    addedToFavorites: 'Added to favorites',
    removedFromFavoritesDescription: 'Comic removed from your favorites',
    addedToFavoritesDescription: 'Comic added to your favorites',
    options: 'Options',
    copyLink: 'Copy Link',
    ...
    ratingSubmittedMessage: 'Thank you for rating this comic!'
  }
};
