...
export const ruTranslations = {
  ...
  'settings.theme': 'Тема',
  'settings.themeDescription': 'Тема будет применена на всех ваших устройствах.',
  'settings.theme.auto': 'Авто',
  'settings.theme.autoDesc': 'Автоматически переключается между светлой и темной темой',
  'settings.theme.system': 'Системная',
  'settings.theme.systemDesc': 'Следует настройкам вашего устройства',
  ...
  'security.twoFactor.description': 'Добавьте дополнительный уровень безопасности для вашей учетной записи',
  'security.twoFactor.status': 'Двухфакторная аутентификация',
  'security.twoFactor.enabled': 'Включена',
  'security.twoFactor.disabled': 'Выключена',
  'security.twoFactor.scanQR': 'Отсканируйте этот QR-код с помощью вашего приложения аутентификатора',
  'security.twoFactor.enterCode': 'Введите 6-значный код из вашего приложения',
  'security.twoFactor.verify': 'Подтвердить',
  'security.twoFactor.qrCodeGenerated': 'QR-код сгенерирован. Пожалуйста, отсканируйте его с помощью вашего приложения аутентификатора.',
  'security.twoFactor.invalidCode': 'Пожалуйста, введите действительный 6-значный код',
  'security.twoFactor.enableError': 'Не удалось включить двухфакторную аутентификацию',
  'security.twoFactor.verificationError': 'Не удалось подтвердить код. Пожалуйста, попробуйте снова.',
  'security.twoFactor.disableError': 'Не удалось отключить двухфакторную аутентификацию',
  ...
  'search.historyCleared': 'История поиска очищена',
  'search.error': 'Поиск не удался. Пожалуйста, попробуйте снова.',
  ...
  'home.todayReading': 'сегодня • вечер уютный • сказочное чтение',
  'home.weekdays.0': 'Вс',
  'home.weekdays.1': 'Пн', 
  'home.weekdays.2': 'Вт',
  'home.weekdays.3': 'Ср',
  ...
  'auth.welcome': 'Добро пожаловать в ReadNest - платформу для писателей и читателей',
  'auth.terms': 'Используя это приложение, вы соглашаетесь с нашими условиями использования и политикой конфиденциальности.',
  ...
  'auth.registrationFailed': 'Не удалось зарегистрировать аккаунт. Возможно, это имя уже занято.',
  'auth.success': 'Успешно',
  'auth.registrationSuccess': 'Аккаунт успешно создан!',
  'auth.unexpectedError': 'Произошла непредвиденная ошибка',
  'auth.loggingIn': 'Вход...',
  'auth.registering': 'Регистрация...',
  'auth.usernameMinLength': 'Имя пользователя должно содержать не менее 3 символов',
  'auth.usernameMaxLength': 'Имя пользователя должно содержать не более 20 символов',
  'auth.usernameFormat': 'Имя пользователя должно начинаться с буквы и может содержать только латинские буквы, цифры и символ подчеркивания',
  'auth.passwordMinLength': 'Пароль должен содержать не менее 8 символов',
  'auth.passwordMismatch': 'Пароли не совпадают',
  'auth.loginSuccess': 'Вход выполнен успешно! Добро пожаловать обратно.',
  'auth.emailNotConfirmed': 'Email не подтвержден. Пожалуйста, проверьте свою почту.',
  'auth.userExists': 'Пользователь уже существует. Пожалуйста, попробуйте войти.',
};
